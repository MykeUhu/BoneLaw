...
void UMVVM_LoadScreen::NewSlotButtonPressed(int32 Slot, FString EnteredName)
{
	...
	StoneGameMode->SaveSlotData(LoadSlots[Slot], Slot);
...
void UMVVM_LoadScreen::LoadData()
{
	...
	for (const TTuple<int32, UMVVM_LoadSlot*> LoadSlot : LoadSlots)
	{
		ULoadScreenSaveGame* SaveObject = StoneGameMode->GetSaveSlotData(LoadSlot.Value->GetLoadSlotName(), LoadSlot.Key);
